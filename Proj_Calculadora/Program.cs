...
Console.WriteLine("\nBEM VNDO A CALCULADORA SIMPLES DE DOIS VALORES");
decimal numero01 = 0m, numero02 = 0m;
...
switch (escolha)
{
    case "1":
        ...
        Console.WriteLine($"As operações com o numero {numero01} e o numero {numero02} é:");
        Console.Write($"Soma:{numero01 + numero02}\nSubtração:{numero01 - numero02}\nMultiplicação:{numero01 * numero02}\nDivisão:{(numero01 / numero02).ToString("N2")}\n");
        break;
    case "2":
        Console.WriteLine("Qual operação você deseja fazer:\n1-Adição\n2-Subtração\n3-Multiplicação\n4-Divisão");
        Console.Write("Qual opção desja fazer: ");
        ...
        {
            case "1":
                Console.WriteLine($"A soma dos números {numero01} e {numero02} é igual: {numero01 + numero02}");
                break;
            case "2":
                Console.WriteLine($"A subtração dos números {numero01} e {numero02} é igual: {numero01 - numero02}");
                break;
            case "3":
                Console.WriteLine($"A multiplicação dos números {numero01} e {numero02} é igual: {numero01 * numero02}");
                break;
            case "4":
                Console.WriteLine($"A divisão dos números {numero01} e {numero02} é igual: {(numero01 / numero02).ToString("N2")}");
                break;
            default:
                Console.WriteLine("Valor inválido");
                break;
